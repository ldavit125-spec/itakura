...
import { REPORT_PERIOD_OPTIONS } from "@/constants/report-labels";
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 shadow-sm space-y-3 mb-6 print:hidden">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 pb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm text-gray-800">보고서 조회 기간 및 세부 필터 조건</span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
        {/* 1. 기간 선택 */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">조회 기간 선택</label>
          <select
        ...
        {/* 2. 시작일 */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">시작일</label>
          <input
            type="date"
        ...
        {/* 3. 종료일 */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">종료일</label>
          <input
            type="date"
        ...
        {/* 4. 제품 필터 */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">제품 선택</label>
          <select
        ...
        {/* 5. 생산라인 필터 */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">생산라인 선택</label>
          <select
        ...
        {/* 6. 자재 필터 */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">자재 선택</label>
          <select
