    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">
          {isJa ? "全原材料LOT" : "전체 원재료 LOT"}
        </p>
        <p className="text-2xl font-extrabold text-blue-600 mt-1">
          {summary.totalRawLotCount}
          <span className="text-xs font-normal text-gray-500 ml-1">{isJa ? "件" : "개"}</span>
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        ...
        <p className="text-2xl font-extrabold text-teal-600 mt-1">
          ...
          <span className="text-xs font-normal text-gray-500 ml-1">{isJa ? "件" : "건"}</span>
        </p>
      </div>
