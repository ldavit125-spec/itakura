  ...
  return (
    <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-2xl p-6 text-white shadow-lg mb-6">
      <h3 className="text-lg font-bold mb-1 flex items-center gap-2">
        ...
        <span>원재료 및 완제품 통합 LOT 이력 검색</span>
      </h3>
      ...
      <form onSubmit={handleSubmit} className="relative flex items-center max-w-3xl">
        <input
          ...
          placeholder="예: LOT-FLOUR-260730-A / FG-PRD001-20260730-001 / WO-20260730-001 / IQC-20260730-001"
      ...
      {recentSearches.length > 0 && (
        <div className="flex items-center gap-2 mt-4 text-xs">
          <span className="text-blue-200 font-semibold whitespace-nowrap">최근 검색어:</span>
